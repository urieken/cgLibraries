/**
 * @file ClearColorScene.cpp
 * @author Ulysses Don Rieken (ulysses.rieken@gmail.com)
 * @brief Source for clear color scene
 * @version 0.1
 * @date 2022-01-16
 * 
...
ClearColorScene::ClearColorScene(const std::uint32_t& event) :
    ClearColorScene{event, CLEAR_COLOR_SCENE_TITLE,
...
auto ClearColorScene::OnEvent(const Event::IEvent& event) -> bool {
...
auto ClearColorScene::OnKeyDownEvent(const SDL_KeyboardEvent& event) -> bool {
...
auto ClearColorScene::OnWindowEvent(const SDL_WindowEvent& event) -> bool {
    switch(event.event) {
...
auto ClearColorScene::AppendSetDrawColorCommand(const SDL_Color& color) -> void {
